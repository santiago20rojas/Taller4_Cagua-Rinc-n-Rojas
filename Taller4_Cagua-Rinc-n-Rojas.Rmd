...
Base_Final98 <- Base_Final %>% 
  select(ends_with("98"))
ggpairs(Base_Final98,diag = list(continuous = wrap("barDiag", fill = "lightblue", colour= "black")))+ labs(title = "Diagrama de dispersión y correlograma de variables de estudio para 1998", caption = "Fuente: Elaboración propia con datos del Banco Mundial")
```
...
Base_Final18 <- Base_Final %>% 
  select(ends_with("18"))
ggpairs(Base_Final18,diag = list(continuous = wrap("barDiag", fill = "peachpuff2", colour= "black")))+ labs(title = "Diagrama de dispersión y correlograma de variables de estudio para 2018", caption = "Fuente: Elaboración propia con datos del Banco Mundial")
```
